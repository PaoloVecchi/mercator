...
return [
    ...
    'application' => [
        ...
        "fields" => [
            ...
            "editor" => "Publisher",
            "editor_helper" => "Application's publisher",
    ...
    'building' => [
        ...
        'fields' => [
            ...
            'attributes' => 'Attributes',
            'attributes_helper' => 'Attributes (ex: camera, badge...)',
        ],
    ...
    'externalConnectedEntity' => [
        ...
        'fields' => [
            ...
            'dest_desc_helper' => 'Desctination description',
        ],
    ...
    'logicalServer' => [
        ...
        'fields' => [
            ...
            'disk' => 'Disk size',
            'disk_helper' => 'Allocated storage space (GB)',
            'disk_used' => 'Storage used',
            'disk_used_helper' => 'Used storage space (GB)',
